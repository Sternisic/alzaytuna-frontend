...
export default function SideCard({
  ...
  return (
    <div className="flex flex-col bg-white rounded-xl shadow hover:shadow-md transition overflow-hidden h-full">
      {/* Bild */}
      {thumbnail?.url && (
      ...
      <div className="p-5 flex flex-col h-full text-right">
        {/* Kategorien */}
        {categories.length > 0 && (
